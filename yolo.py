...
#LABELS=["mountain","food","dinosarus","flower","buliding","monumnet","lion"]
...
#for img in glob.glob("C:\\Users\\tanka\\yolo-object-detection\\corel1k\\*.jpg"):
#for img in glob.glob("E:\\images\\*.jpg"):
		...
		print("----------------------------------------"
			  "---------------------------------------------")
		if len(c) == 0:
			print("IMAGE CAN'T BE DETCTED")
		print("MODIFED WITH 50% PROBALITY ,WILL SHOW CLASS NAME W.R.T COUNT")
		print(c)
		print("image name")
		print(str(img))
		import shutil
